...
tags: [时间管理, GTD, 番茄工作法, Notion自动化, 时间块规划]
...
作为全栈工程师，我曾深陷时间管理困境：
<div data-chart='{"type": "echarts", "options": {"title": {"text": "周三时间安排冲突"}, "tooltip": {"trigger": "axis"}, "xAxis": {"type": "category", "data": ["09:00", "11:00", "14:00", "15:00", "19:00", "22:00"]}, "yAxis": {"type": "value"}, "series": [{"type": "bar", "data": [2, 3, 1, 1.5, 2, 3]}], "responsive": true}}'></div>
...
<div data-chart='{
  "type": "echarts",
  "options": {
    "title": {"text": "番茄工作法时间分配"},
    "tooltip": {"trigger": "axis", "axisPointer": {"type": "shadow"}},
    "xAxis": {"type": "category", "data": ["工作任务1", "短暂休息", "工作任务2"]},
    "yAxis": {"type": "value", "name": "时间(分钟)"},
    "series": [{"type": "bar", "data": [25, 5, 25]}]
  }
}'>
</div>
...
### GTD工作流
<div data-chart='{"type": "chartjs", "options": {"type": "radar", "responsive": true, "data": {"labels": ["黄金时段", "平稳时段", "低谷时段"], "datasets": [{"label": "能量水平", "data": [35, 25, 40]}]}}}'></div>
